...
def set_start_urls(settings):
    ...
    start_urls = ['http://www.gva.be/zoeken?keyword={0}&datestart={1}&dateend={2}'.format(term, start_str, end_str)]
    return start_urls


class GazetVanAntwerpenSpider(CrawlSpider):
    name = 'gva' # name of the spider, to be used when running from command line
    allowed_domains = ['www.gva.be']
